...
#pragma warning restore CS0618
    ...
    private static Texture2D DrawIcon(int size)
    {
        ...
        // 타일 본체
        DrawRoundedRect(pixels, size, midX,   topY, tileW, tileH, radius, new Color(1.00f, 0.60f, 0.10f, 1f)); // 주황
        DrawRoundedRect(pixels, size, leftX,  botY, tileW, tileH, radius, new Color(0.18f, 0.82f, 0.42f, 1f)); // 초록
        DrawRoundedRect(pixels, size, rightX, botY, tileW, tileH, radius, new Color(0.35f, 0.65f, 1.00f, 1f)); // 하늘
